...
This is as-yet unproven, but the empirical results are encouraging. It is clearly valid for binary populations given the equivalence to Clopper-Pearson, but the level over $\mathcal{F}_{[0,1]}$ is unproven. There is work being done by [My Phan and colleagues](https://arxiv.org/abs/2106.03163) at UMass Amherst CS. [Bickel (1992)](https://www.jstor.org/stable/1403650) has some interesting explorations of the Stringer bound and modifications, which may also relate to the ideas here.
