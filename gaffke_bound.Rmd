...
\end{align}
where $y_{n+1} = 1$. Note that $\sum_{i=1}^n y_i D_i$ is exactly equal to the Bayesian bootstrap of the sample mean, as suggested by [Rubin, 1981](https://projecteuclid.org/journals/annals-of-statistics/volume-9/issue-1/The-Bayesian-Bootstrap/10.1214/aos/1176345338.full). $G(\bs{y})$ simply augments the random sample with a single point equal to the upper bound of the support, runs the Bayesian bootstrap, and takes the upper tail of the Bootstrap distribution. The proposed test is
